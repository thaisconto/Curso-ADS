...
INSERT INTO Locacao VALUES (NULL, 1, 1, 3);
INSERT INTO Locacao VALUES (NULL, 2, 2, 7);
INSERT INTO Locacao VALUES (NULL, 3, 3, 1);
INSERT INTO Locacao VALUES (NULL, 4, 4, 3);
INSERT INTO Locacao VALUES (NULL, 5, 5, 7);

-- --------------------------------------------------
-- View que seleciona todas as locações e seus respectivos veículos e clientes.
-- --------------------------------------------------
CREATE VIEW LocacaoClienteVeiculo as
SELECT Clientes.nome_cliente, Veiculos.nome_veiculo, Veiculos.valor_diaria, Locacao.dias
FROM Locacao
JOIN Clientes
